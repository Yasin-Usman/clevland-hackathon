...
class AIModels:
    def __init__(self):
        ...
        self.tts_voice_en = PiperVoice.load(
            "/mnt/c/Users/yasin/Desktop/cleveland/YasinAi/piper_models/en_US-lessac-medium.onnx"
        )
        
        # Load Arabic TTS  
        self.tts_voice_ar = PiperVoice.load(
            "/mnt/c/Users/yasin/Desktop/cleveland/YasinAi/piper_models/ar_JO-kareem-medium.onnx"
        )
...
async def process_audio(audio: UploadFile = File(...)):
    ...
    try:
        ...
        detected_language = result.get("language", "en")  # Get detected language
