...
export const HumanloopLogomark = (
  ...
  <svg viewBox="0 0 3000 3000" {...props}>
    <path
      fill="currentColor"
    ...
    <header className="sticky top-0 z-50 flex h-16 w-full shrink-0 items-center justify-between border-b bg-gradient-to-b from-background/10 via-background/50 to-background/80 px-4 backdrop-blur-xl">
      <div className="mr-12 flex items-center">
        <Link href="/" target="_blank" rel="nofollow">
          <img
            src="https://www.clevelandclinicabudhabi.ae/-/media/project/ccad/websites/shared/logo/ccad_logo_updated.svg?la=en&hash=95B2991349BAD1569C5E0684803B9B2F"
            alt="Cleveland Clinic Abu Dhabi"
            className="mr-2 h-10 w-auto md:h-12"
          />
        </Link>
      </div>

      <NewChatButton onReset={onReset} />
